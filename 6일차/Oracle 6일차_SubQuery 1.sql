...
SELECT DEPT_CODE, EMP_NAME, SALARY, (SELECT FLOOR(AVG(SALARY)) FROM EMPLOYEE WHERE DEPT_CODE = E.DEPT_CODE) "부서별 급여평균"
FROM EMPLOYEE E
...
SELECT DEPT_CODE, EMP_NAME, SALARY, AVR(SALARY)
*/
...
-- @실습문제2
-- 모든 직원의 사번, 이름, 소속부서를 조회한 수 부서명을 오름차순으로 정렬하시오.
