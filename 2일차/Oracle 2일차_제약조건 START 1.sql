...
-- 1, khuser01, pass01, 일용자, 남, 01027227373, khuser01@gmail.com
INSERT INTO USER_NO_CONSTRAINT(USER_NO, USER_ID, USER_PWD, USER_NAME, USER_GENDER, USER_PHONE, USER_EMAIL)
VALUES(1, 'khuser01', 'pass01', '일용자', '남', '01027227373', 'khuser01@gmail.com');
ROLLBACK;
COMMIT;
-- 제약조건
INSERT INTO USER_NO_CONSTRAINT
VALUES(2, 'khuser02', null, null, null, null, null);  -- 비어있는 상태로 남기면 안된다.
...
VALUES(1, 'khuser01', 'pass01', '일용자', null, null, null);
INSERT INTO USER_PRIMARY_KEY
VALUES(1, 'khuser02', 'pass02', '이용자', null, null, null); -- 'khuser02' 자리에 null이 들어가면 에러발생. why? unique not null
SELECT * FROM USER_PRIMARY_KEY;
DELETE FROM USER_PRIMARY_KEY WHERE USER_ID = 'khuer01';
COMMIT;
...
-- CHECK, CHECK(컬럼명 IN(값1, 값2)); : 지정한 값만 들어가게 함. 지정값은 여러개 가능.
...
CREATE TABLE USER_DEFAULT (
    ...
    USER_PHONE VARCHAR2(30),
    USER_EMAIL VARCHAR2(50),
    USER_DATE DATE DEFAULT SYSDATE    -- 여기에 설정해 놓으면 아래 INSERT에서 그냥 DEFAULT 쓰면됨.
);
DROP TABLE USER_DEFAULT;
INSERT INTO USER_DEFAULT
VALUES(1, 'khuser01', 'pass01', '일용자', 'M', '01082829292', 'khuser01@gmail.com', '24/06/14');
INSERT INTO USER_DEFAULT
VALUES(2, 'khuser02', 'pass02', '일용자', 'M', '01082829292', 'khuser02@gmail.com', DEFAULT);
INSERT INTO USER_DEFAULT
VALUES(3, 'khuser03', 'pass03', '일용자', 'M', '01082829292', 'khuser03@gmail.com', SYSDATE+7);
SELECT * FROM USER_DEFAULT;
-- 제약조건
-- 1. NOT NULL : NULL이 들어가지 않게 함
-- 2. UNIQUE : 중복이 되지 않게 함. NULL은 가능
-- 3. PRIMARY KEY : 중복도 안되고 NULL도 되지 않도록 함. 유일한 값.
...
INSERT INTO USER_GRADE VALUES(40, 'VIP회원');  -- 2. 아래 INSERT VALUES의 40값을 넣고 싶으면 여기서 USER_GRADE VALUES에 40값을 넣어줘야 함.
...
INSERT INTO USER_FOREIGN_KEY
VALUES(4, 'khuser04', 'pass04', '사용자', 'M', null, null, DEFAULT, 40); -- 1. 안되는 이유 : GRADE_CODE NUMBER REFERENCES USER_GRADE(GRADE_CODE) 
...
-- 테이블명 : SHOP_MEMBER
-- 저장해야할 데이터 : 1, khuser01, pass01, 일용자, M, 01082829292, khuser01@gamil.com
...
DROP TABLE SHOP_BUY;
-- SHOP_BUY의 USER_ID는 SHOP_MEMBER의 USER_ID를 가지고 있는 khuser01, khuser02 등..만 넣을 수 있어요.
SELECT * FROM SHOP_BUY;
INSERT INTO SHOP_BUY
VALUES(1, 'khuser01', '농구화', DEFAULT);
INSERT INTO SHOP_BUY
VALUES(2, 'khuser02', '축구화', DEFAULT); -- parent key not found : khuser02가 없어서 에러발생.

-- 외래키 FOREIGN KEY
-- 자식테이블에서 부모테이블이 가지고 있는 컬럼의 필드값으로만 INSERT하도록 하는것.
-- 참조 무결성을 보장하는 제약조건이다.
-- 외래키 설정방법
-- 컬럼레벨 : REFERENCES 부모테이블(컬럼명) ON DELETE SET NULL or ON DELETE CASCADE(삭제옵션이다)
-- GRADE_CODE NUMBER REFERENCES USER_GRADE(GRADE_CODE) ON DELETE CASCADE
-- 외래키 삭제옵션
-- 1. 기본 옵션 ON DELETE RESTRICTED
-- 2. 연관된 모든 것 삭제 옵션 : ON DELETE CASCADE
-- 3. NULL로 만드는 삭제 옵션 :  ON DELETE SET NULL
-- 부모테이블의 데이터 삭제 시도시 자식테이블의 데이터를 처리하는 방법.
